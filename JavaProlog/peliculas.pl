...
genero([drama,romance,comedia,misterio,suspenso,comediaRomantica,romance,musical,horror,accion,crimen,ciencia_ficcion,aventura,fantasia]).
...
denero(army_of_the_dead,[accion,crimen,horror]).
